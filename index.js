           ...
           var apiData = await fetch("https://www.googleapis.com/youtube/v3/playlistItems?key=AIzaSyAa-o55aIMt4YC0mhPyp8WfGql5DVg_fp4&part=snippet&maxResults=50&playlistId="+playlistId, {
              ...
              apiData = apiData.items.map((e)=>{
                  ...
                  return {
                      ...
                      thumb:!('url' in thumbs[Object.keys(thumbs)[Object.keys(thumbs).length - 1]]) ? 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFzCfRhbjyor9E6NQfWWk9rYfUctTG90aOtw&usqp=CAU' : thumbs[Object.keys(thumbs)[Object.keys(thumbs).length - 1]].url,
